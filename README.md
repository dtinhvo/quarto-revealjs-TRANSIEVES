A combined Quarto revealjs theme for the TRANSIEVES project that allows for persistent headers, with modifications based on [reveal-header](https://github.com/shafayetShafee/reveal-header).  
